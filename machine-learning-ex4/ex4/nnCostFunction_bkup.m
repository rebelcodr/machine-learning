...
for t = 1:m
  ...
  % --- A1 (1x401) Theta1 (25x401) => A2 (1x26) ---
  A2 = [1, sigmoid(A1 * Theta1')];

  % --- A2b (1x26) Theta2 (10x26) ---
  A3 = sigmoid(A2 * Theta2');

  % --- yMatrix (1x10) A3 (1x10) => delta3(1x10)---
  delta3 = A3 - yMatrix(t, :);

  % Compute hidden layer delta
  % --- Theta2 (10x26), delta3 (1x10) => delta2(26x1) ---
  delta2 = (Theta2' * delta3') .* sigmoidGradient(A2');

  % --- delta2(25x1) ---
  delta2 = delta2(2:end);

  % --- Theta2_grad(10x26), delta3(1x10), A2(1x26) ---
  Theta2_grad = Theta2_grad + delta3' * A2;

  % --- Theta1_grad(25x401), delta2(25x1), A1(1x401) ---
